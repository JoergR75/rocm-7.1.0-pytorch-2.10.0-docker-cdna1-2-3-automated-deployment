#!/bin/bash
# ================================================================================================================
# ROCm 7.1.0 + OpenCL 2.x + PyTorch 2.10.0 (nightly for ROCm7) + Transformers + Docker Setup
# Compatible with Ubuntu 22.04.x and 24.04.x (Desktop & Server) — Ubuntu 20.04.x is no longer supported
# ================================================================================================================
# Description:
# This script automates the installation of AMD ROCm 7.1.0, PyTorch 2.10.0 (nightly for ROCm7), Transformers, and Docker
...
install_focal() {
    print '\nUbuntu 20.04.x (focal) is not longer be supported for ROCm 7.1.0 The last supported version is ROCm 6.4.0.\n'
...
install_jellyfish() {
    ...
    sudo DEBIAN_FRONTEND=noninteractive apt-get install -yq ./amdgpu-install_7.1.70100-1_all.deb

    # Installing multiple use cases including ROCm 7.0.2, OCL and HIP SDK

    print '\nInstalling ROCm 7.1.0 + OCL 2.x environment ...\n'
...
install_noble() {
    ...
    # Install with "default" settings (no interaction)
    sudo DEBIAN_FRONTEND=noninteractive apt install -y ./amdgpu-install_7.1.70100-1_all.deb
...
print '\n✅ Finished ROCm 7.1.0 + OCL 2.x + PyTorch 2.10.0 (nightly for ROCm7) + Transformers environment installation and setup.\n'
